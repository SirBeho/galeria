  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="detalleModalLabel">Detalle del Artículo</h4>
      ...
      <div class="modal-body">
        ...
        <div style=" position:relative; border-radius: 0.5rem; overflow: hidden;width: fit-content;">
        ...
        <form id="add_form" style="display: flex;gap:1rem; margin-top: 1rem; border: solid black; border-radius: 1rem; padding: 1rem;">
          ...
          <button type="submit" class="btn btn-primary">
            <svg xmlns="http://www.w3.org/2000/svg" height="3em" fill="white" viewBox="0 0 640 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
